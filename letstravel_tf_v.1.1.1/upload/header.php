		      ...
		      <a href="#"><i></i></a>
			  	...
			  	<ul>
					...
					<li class="type-1"><a href="#">Tour Packages<span class="fa fa-angle-down"></span></a>
						<ul class="dropmenu">
							<li><a href="royal_rajasthan.php">Royal Rajasthan</a></li>
							<li><a href="delhi_agra_delhi.php">Agra Delhi Agra</a></li>
							<li><a href="delhi_agra_jaipur_delhi.php">Agra Delhi Jaipur Agra</a></li>	
						</ul>
